...
CREATE TABLE IF NOT EXISTS loan_installments (
    ...
    amount_paid DECIMAL(10, 2) NULL COMMENT 'Valor efetivamente pago',
    adjustment_amount DECIMAL(10, 2) DEFAULT 0.00 COMMENT 'Valor do ajuste (positivo = acréscimo, negativo = desconto)',
    adjustment_reason VARCHAR(255) NULL COMMENT 'Motivo do ajuste',
    paid_by VARCHAR(100) NULL COMMENT 'Forma de pagamento',
